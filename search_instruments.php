	...
	if(isset($_SESSION['key']) && isset($_SESSION['validation']))
	{
		...
		else
		{
			...
			if(isset($_POST['instrument_name']))	
			{
				if($_POST['text_name1']!="")
				{
					die("<script>location.href = 'result_instruments.php?instrument_name=".$_POST['text_name1']."'</script>");
				}
				else
			...
			if(isset($_POST['model_name']))	
			{
				if($_POST['text_name2']!="")
				{
					die("<script>location.href = 'result_instruments.php?model=".$_POST['text_name2']."'</script>");
				}
				else
...
<body>
	...
	<div id = "container1">
		<form  method="post" action="search_instruments.php"  id="searchinstrument"> 
	      	...
	      	<input type="submit" name="instrument_name" value="Instruments" class="css_button"> 
	    </form> 
	</div>
	<div id = "container2">
		<form  method="post" action="search_instruments.php"  id="searchmodel"> 
